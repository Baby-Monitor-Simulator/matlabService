...
if pOCA(ico)<12
    P(ico)=1e-6*qfet*Prod0*exp(-pOCA(ico)/ka); %gefit op data van Cohen, omgerekend naar ml/s: netto-verschil tussen aanmaak/afbraak in foetale en mix compartiment
else
    P(ico)=Prodn;
end
