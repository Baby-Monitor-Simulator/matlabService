...
if brain==1;
    ...
    if convf==3
        if mother==1
            figure; plot(tom(1:ico-1),pOsav(1,1:ico-1),tom(1:ico-1),pOsav(3,1:ico-1),tom(1:ico-1),pOsav(4,1:ico-1),tom(1:ico-1),pOsav(2,1:ico-1),tom(1:ico-1),pOsav(6,1:ico-1),tom(1:ico-1),pOsav(5,1:ico-1),tom(1:ico-1),pOsav(7,1:ico-1),'g')
       ...
       elseif scen==2.1
            ...
            axis([-1,10,100,150])
            subplot(5,1,2)
            plot(tom/60,nonzeros(100./(1+(10400./(pOsav(2,:).^3+150*pOsav(2,:))))),'k')
            ylabel('SaO_{2} [%]')
            axis([-1,10,0,100])
            subplot(5,1,3)
            ...
            axis([-1,10,800,1000])
            subplot(5,1,4)
            plot(tom/60,pOsav(7,1:ico),tom/60,pOsav(2,1:ico),'k')
        ...
        elseif scen==3||scen==3.1
            ...
            axis([0,3,0,120])
            subplot(6,1,2)
            plot(tom/60,60e6*a2(7,:)',tom/60,60e6*a2(8,:)')
            legend('q_{um,a}','q_{um,v}')
            ylabel('q_{um} [ml/min]')
            axis([0,3,0,1000])
            subplot(6,1,3)
            plot(tom/60,1e6*a2(14,:)','k')
            ylabel('V_{ven} [ml]')
            axis([0,3,130,170])
            subplot(6,1,4)
            plot(tom/60,mfpart(1:ico),'k')
            ...
            axis([0,3,30,45])
            subplot(6,1,5)
            plot(tom/60,pOsav(6,1:ico),tom/60,pOsav(4,1:ico))
