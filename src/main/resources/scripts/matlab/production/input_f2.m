...
elseif CAVmodel==2 
 ...
 % material properties
    ...
    fTa0     = 85;    % [kPa] - scaling parameter for active stress
...
fVv0      = fVun*0.8*(2/3)*fVtotal-7-fV0lv;            % [ml] - systemic arterial extra thoracic node 

% --- resistances

fRa  = 10;             % [kPa.ms/ml] - aortic valve + systemic arterial intra thoracic segment   
fRp  = 80;             % [kPa.ms/ml] - systemic arterial extra thoracic segment
fRv  = 5;              % [kPa.ms/ml] - mitral valve resistance
fCa  = 1.5;           % [ml/kPa] - systemic arterial intra thoracic node 
fCv  = 48;              % [ml/kPa] - systemic arterial extra thoracic node 
fLa  = 20;%0.00024*10^5;       % [kPa.ms^2/ml] - extrathoracic blood flow inertia
...
if umbilical==1
    Vum0    = fVun*0.8*(1/3)*fVtotal; % 1/3 of 80% venous unstressed volume of 70% of total blood
    Cum     = 11;
    Ruma    = 0.5*fRp;
    Rummc   = 3*fRp;
