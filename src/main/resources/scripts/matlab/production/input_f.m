...
elseif CAVmodel==2 
 ...
 % material properties
    ...
    fTa0     = 56.;     % [kPa] - scaling parameter for active stress
...
% --- unstressed volumes
fVtotal   = 300;            % [ml] - total blood volume 
fV0lv     = 5;             % [ml]      - intercept volume LV
fVa0      = 41;             % [ml] - systemic arterial intra thoracic node 
fVv0      = 107;            % [ml] - systemic arterial extra thoracic node 

% --- resistances

fRa  = 8;             % [kPa.ms/ml] - aortic valve + systemic arterial intra thoracic segment   
fRp  = 90;             % [kPa.ms/ml] - systemic arterial extra thoracic segment
fRv  = 0.8;              % [kPa.ms/ml] - mitral valve resistance
fCa  = 0.6;           % [ml/kPa] - systemic arterial intra thoracic node 
fCv  = 12;              % [ml/kPa] - systemic arterial extra thoracic node 
fLa  = 0.00024*10^5;       % [kPa.ms^2/ml] - extrathoracic blood flow inertia
...
if umbilical==1
    Vum0    = 56; % 1/3 of 80% venous unstressed volume of 70% of total blood
    Cum     = 12;
    Ruma    = 0.2*fRp;
    Rummc   = 0.94*fRp;
