...
% --- unstressed volumes
fVtotal   = 330;        % [ml] - total blood volume: 3kg *110 ml/kg  
fV0lv     = 5;          % [ml] - intercept volume LV
fVa0      = 20;       % [ml] - systemic arterial intra thoracic node 
fVv0      = 100;       % [ml] - systemic arterial extra thoracic node 

% --- resistances

fRp  = 200;             % [kPa.ms/ml] - systemic arterial extra thoracic segment
...
%if umbilical==2; fCa=0.5*fCa; fVa0=0.8*fVa0; end
...
elseif umbilical==2
    ...
    Vumv0    = 80;    %identiek  
    Cuma     = 0.01;  % gaat af van art. compliantie   
    Cumv     = 8.2;
    Ruma    = 1.1*fRp;   %opzoeken!! verhouding R, som identiek aan normaal
    Rummc   = 1.8*fRp;
    Rumv    = 0.6*fRp;
